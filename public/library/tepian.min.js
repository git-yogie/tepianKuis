...
class tepianKuis extends EventEmitter {
    ...
    axiosInit() {
        this.apiClient = axios.create({
            baseURL: "https://tepiankuis.softforge.my.id/api/embed/quiz",
            timeout: 10000,
            headers: {
    ...
    nextSoal() {
        ...
        if (this.soal_len - 2 === this.index_soal) {
    ...
    finishQuiz() {
        ...
        this.emit("selesai", { jawaban: this.jawabanUser, poin: poin, benar: jumlahBenar,nilai: ((jumlahBenar / this.soal_len) * 100).toFixed(2)});
        if(this.saveAnsw){
            this.sendUserAnswer({ 
                jawaban_user: this.jawabanUser,  
                jumlahBenar: jumlahBenar ,
                nilai: ((jumlahBenar / this.soal_len) * 100).toFixed(2),
        ...
        textPoin.textContent = `${(jumlahBenar / this.soal_len) * 100}`
