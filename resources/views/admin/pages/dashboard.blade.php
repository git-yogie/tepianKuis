                            ...
                            <div class="card-body px-4 py-4-5">
                                <div class="row">
                                    ...
                                    <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                        ...
                                        <h6 class="font-extrabold mb-0">{{ $data['quiz_count'] }}</h6>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body px-4 py-4-5">
                                <div class="row">
                                    ...
                                    <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                        ...
                                        <h6 class="font-extrabold mb-0">{{ $data['api_log'] }}</h6>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body px-4 py-4-5">
                                <div class="row">
                                    ...
                                    <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                        ...
                                        <h6 class="font-extrabold mb-0">{{ $data['peserta_count'] }}</h6>
                                    </div>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td class="col-3">
                                                    <div class="d-flex align-items-center">
                                                        <div class="avatar avatar-md">
                                                            <img src="{{ asset('mazer') }}/images/faces/2.jpg">
                                                        </div>
                ...
                <div class="card">
                    <div class="card-body py-4 px-5">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ms-3 name">
                                <h5 class="font-bold">{{ Auth::guard('admin')->User()->nama }}</h5>
                                <h6 class="text-muted mb-0">{{ '@' . Auth::guard('admin')->User()->username }}</h6>
                            </div>
                        </div>
                    </div>
                </div>
...
@section('js')
    <script>
        axios.get("{{ route('admin.api.threeday') }}")
            .then((response) => {
                ...
                var chart = new ApexCharts(document.querySelector("#chart-api-access"), options);
                chart.render();
                console.log(data);
            })
            .catch((err) => {
